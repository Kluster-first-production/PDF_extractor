...
# def save_to_csv(data_list, file_name="invoice_data.csv"):
...
# def save_to_csv(data_list, file_name="invoice_data.csv"):
#     """
#     data_list = list of invoice dicts
#     Each invoice dict contains:
#       - Invoice Number
#       - User Name
#       - Due Date
#       - Product Details (list of dicts)
#       - Total Amount
#     """
...
#                 })
#         else:
#             # If no product details, still add invoice summary
#             rows.append({
#                 "Invoice Number": invoice_number,
#                 "User Name": user_name,
#                 "Due Date": due_date,
